...
def subject_card(name, code, section, stats=None, footer_callback=None):
    html = f"""
        ...
        padding:25px;border-radius:20px;border:1px solid black; margin-bottom:20px;">
        ...
        <p style="margin:10px 0; font-weight:600; color:#1e293b;">
            ...
            | <span style="color:#1e293b;">Section:</span>
            <span style="background:#FFE0E0; color:#D32F2F; padding:2px 8px; border-radius:5px;">{section}</span>
        </p>
        """
    if stats:
        html += """
